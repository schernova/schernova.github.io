...
<img src="{{ site.baseurl }}/files/ai-caring image.jpg" alt="Profile" style="float: right; margin-right: 20px; margin-bottom: 10px; max-width: 40%; height: auto;">

Since 2021, I have also served as Executive Director and Principal Investigator of [AI-CARING](https://ai-caring.org/), and NSF National AI Institute who's mission is to develop the next generation of personalized, collaborative AI systems that support aging adults living independently at home. The Institute brings together researchers across AI, robotics, human–computer interaction, ethics, and the social sciences to develop foundational technologies, evaluation frameworks, and deployment methodologies that emphasize trust, transparency, and real-world impact.
